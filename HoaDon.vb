...
Public Class frmHoaDon
    ...
    Private Sub btnT_Click(sender As Object, e As EventArgs) Handles btnT.Click
        ...
        Dim SP As String = "insert into HOA_DON Values (@MA_HD, @KHACH_HANG_MA_KH, @DON_GIA, @SO_LUONG, @TONG_TIEN)"
        Dim T As New SqlCommand(SP, ketnoi)
        Try
            T.Parameters.AddWithValue("@MA_HD", TextBox1.Text)
            T.Parameters.AddWithValue("@KHACH_HANG_MA_KH", TextBox2.Text)
            T.Parameters.AddWithValue("@DON_GIA", TextBox3.Text)
            T.Parameters.AddWithValue("@SO_LUONG", TextBox4.Text)
    ...
    Private Sub btnS_Click(sender As Object, e As EventArgs) Handles btnS.Click
        ...
        Dim SP As String = "update HOA_DON Set MA_HD = @MA_HD, KHACH_HANG_MA_KH = @KHACH_HANG_MA_KH, DON_GIA = @DON_GIA, SO_LUONG = @SO_LUONG, TONG_TIEN = @TONG_TIEN"
        Dim T As New SqlCommand(SP, ketnoi)
        Try
            T.Parameters.AddWithValue("@MA_HD", TextBox1.Text)
            T.Parameters.AddWithValue("@KHACH_HANG_MA_KH", TextBox2.Text)
